...
(function (factory, window) {
  ...
  L.TileLayer.MML = L.TileLayer.extend({
    ...
    urls: {
      ...
      peruskartta_3067:
        "http://tiles.kartat.kapsi.fi/peruskartta_3067/{z}/{x}/{y}.jpg",
      taustakartta_3067:
        "http://tiles.kartat.kapsi.fi/taustakartta_3067/{z}/{x}/{y}.jpg",
      ortokuva_3067:
        "http://tiles.kartat.kapsi.fi/ortokuva_3067/{z}/{x}/{y}.jpg",
    },
  ...
  L.tileLayer.mml_wmts = function (options) {
    ...
    var url =
      `https://avoin-karttakuva.maanmittauslaitos.fi/avoin/wmts/1.0.0/${layer}` +
      `/default/ETRS-TM35FIN/{z}/{y}/{x}.png?api-key=${apiKey}`;
